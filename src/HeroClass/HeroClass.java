...
class HeroClass {
    ...
    public int getAttack() {
       ...
       /* try {
            AttackType attack = AttackType.valueOf(userAttack);
            return attack.name(); // Or attack.toString() if you override it
        } catch (IllegalArgumentException e) {
            System.out.println( "this is not the correct attack - try again" );
            getAttack();
        }
 ...
 /*   public String getAttackDmg (String userAttack) {

        AttackType attack = AttackType.valueOf(userAttack);
   //  System.out.println(" The damage of the attack is " + attack.damage);
        return  attack.type;
    }
*/
